...
（2）编译、发布静态文件
编译：docker run -it --rm -v /home/s2iDataGit/rip/rip-web:/home nodejs-zjk:v12.16 cnpm install
发布静态文件：docker run -it --rm -v /home/s2iDataGit/rip/rip-web:/home nodejs-zjk:v12.16 npm run build
（3）文件转移
